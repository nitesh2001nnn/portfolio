...
const Corousel = ({ images, noOfImages: _noOfImages }: caroselTypes) => {
  ...
  return (
    <>
      <div className="carosel-container">
        <button className="button btn-prev" onClick={prevSlide}>
          &lt;
        </button>
        ...
        <button onClick={nextSlide} className="button btn-next">
          &gt;
        </button>
      </div>
      <h1>{images.length}</h1>
